  ...
  return (
    ...
    >
      ...
      <div className="h-3/5 p-5 max-md:p-6 mx-auto my-auto w-full flex flex-col justify-between">
        <h1 className="text-7xl font-bold font-sans ml-20 my-auto dark:text-white max-sm:text-5xl max-sm:mx-auto">
          DITA WEBSITE
        </h1>
      </div>
      <h1 className="dark:text-white max-sm:text-sm text-center">
        Copyright 2023
      </h1>
      <Chatbot />
    </main>
